      ...
      <div className="text-white">
        <div className="">
          ...
          <div className="flex flex-col justify-center items-center text-center gap-2 mt-8 sm:mt-0 sm:gap-4">
            <div className="">
              <h2
                className="font-PlayfairDisplay not-italic font-bold text-lg sm:text-6xl"
                data-aos="fade-down"
              >
                Nuestro blog
              </h2>
            ...
            <div className="sm:w-7/12 lg:w-4/12" data-aos="fade-down">
              <p
                className="font-manrope not-italic font-medium leading-4 sm:leading-6 text-xs mx-4 sm:mx-0 sm:text-xl"
                data-aos="fade-down"
              >
                En este blog, encontrarás información valiosa, consejos
                prácticos y las últimas novedades relacionadas con la
          ...
          <div
            className="flex justify-center sm:hidden mt-8"
            data-aos="fade-right"
          >
            <button
